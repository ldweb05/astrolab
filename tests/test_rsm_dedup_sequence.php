...
require __DIR__ . '/../html/includes/bootstrap.php';
require __DIR__ . '/../html/includes/RicercaRSAirportRepository.php';
require __DIR__ . '/../html/includes/RicercaRSDeduplicator.php';
$pdo=db_connect();
