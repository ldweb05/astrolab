...
- [~] Fase 5: Redazione dei contenuti testuali per le sezioni 6, 7 e 8 (Sezione 6 completata in help_comparatore.php: Comparatore RS/Rilocazioni con limite 2 Free / 3 Supporter, Rule ed Evidenze con stelline e veto)
