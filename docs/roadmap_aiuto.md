...
- [ ] Fase 1: Definizione della struttura e dei titoli dei capitoli (corrente)
- [ ] Fase 2: Creazione dell'infrastruttura di base per il menu Aiuto nell'interfaccia
- [ ] Fase 3: Redazione dei contenuti testuali per le sezioni 1 e 2
