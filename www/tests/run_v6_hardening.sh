...
run_test "$TESTS/test_api_unauthenticated_contract.php"
run_test "$TESTS/test_api_authenticated_contract.php"
...
run_test "$TESTS/test_annual_report_pdf_determinism.php"
