...
<title>Lab Stelline V2 — Astrologia Attiva</title>
...
<style>
/* ── Stelline V2: più piccole + badge colorati ─────────────────────── */
.stelle-v2 { font-size: 11px; letter-spacing: -1px; white-space: nowrap; }
.stelle-v2 .sv { display: inline-block; width: 10px; text-align: center; }
.stelle-v2 .sv-verde   { color: #2ecc40; }
.stelle-v2 .sv-giallo  { color: #ffdc00; }
.stelle-v2 .sv-arancio { color: #ff851b; }
.stelle-v2 .sv-rosso   { color: #ff4136; }
.stelle-v2 .sv-malus   { color: #aaa; font-size: 10px; margin-left: 2px; }
.delta-pos { color: #2ecc40; font-weight: 700; font-size: 12px; }
.delta-neg { color: #ff4136; font-weight: 700; font-size: 12px; }
.delta-zero { color: #888; font-size: 12px; }
.stelle-piene, .stelle-sensib { font-size: 12px !important; letter-spacing: -1px !important; }
.badge-lab { background: #e74c3c; color: #fff; font-size: 10px; padding: 2px 6px; border-radius: 3px; margin-left: 6px; vertical-align: middle; }

/* Legenda V2 sotto paginazione */
.legenda-v2 {
    display: flex;
    flex-wrap: wrap;
    align-items: center;
...
<h2>🔬 Laboratorio Stelline V2 — Confronto Ricerca</h2>
</div>
<!-- ══════════════════════════════════════════════════════════════════
...
eventoCorrente = new EventSource('api/ricerca_stream_v2_api.php?' + params.toString());
...
eventoCorrente = new EventSource('api/ricerca_stream_v2_api.php?' + prossimiParams.toString());
